...
Pengetahuan (*knowledge*) merujuk pada segala bentuk informasi, pemahaman, atau keyakinan yang dimiliki manusia mengenai realitas, baik tentang diri sendiri maupun lingkungan sekitarnya [@Babbie2021; @Kerlinger2000]. Pengetahuan dapat diperoleh melalui berbagai cara, seperti pengalaman pribadi, tradisi, pendidikan formal, maupun interaksi sosial.
...
Ilmu pengetahuan (*science*) merupakan bentuk pengetahuan yang diperoleh melalui proses ilmiah yang sistematis, objektif, dan dapat diuji [@Kerlinger2000; @Creswell2018]. Ilmu pengetahuan tidak hanya bertujuan untuk memahami fenomena, tetapi juga untuk menjelaskan, memprediksi, dan menguji kembali penjelasan tersebut secara empiris.
...
Pengetahuan melalui otoritas diperoleh dengan menerima informasi dari individu atau lembaga yang dianggap memiliki keahlian atau kekuasaan tertentu [@Babbie2021]. Dalam kehidupan akademik, mahasiswa menerima banyak informasi dari dosen, buku teks, atau tokoh ilmiah sebagai sumber yang dapat dipercaya. Pendekatan ini efisien karena memungkinkan transfer pengetahuan secara cepat tanpa harus melakukan verifikasi pribadi terhadap setiap klaim.
...
Intuisi adalah pengetahuan yang muncul secara spontan tanpa melalui proses penalaran yang eksplisit [@Kerlinger2000]. Individu sering kali merasa “yakin” terhadap suatu kesimpulan tanpa mampu menjelaskan proses logis yang mendasarinya. Intuisi dapat terbentuk dari pengalaman masa lalu, pola yang tersimpan dalam memori, atau respons emosional yang cepat.
...
Kelemahan utama intuisi adalah sifatnya yang subjektif dan sulit diverifikasi. Intuisi tidak menyediakan prosedur sistematis untuk menguji kebenarannya dan sangat rentan terhadap bias kognitif, stereotip, serta pengaruh emosi. Oleh karena itu, intuisi tidak dapat dijadikan landasan utama dalam pengambilan keputusan ilmiah.

### Rasionalisme (*Rationalism*)

Rasionalisme menekankan penggunaan penalaran logis sebagai sumber utama pengetahuan [@Creswell2018]. Dalam pendekatan ini, individu menarik kesimpulan melalui proses deduksi berdasarkan prinsip umum yang dianggap benar. Konsistensi logis menjadi ukuran utama dalam menentukan kebenaran suatu pernyataan.
...
Empirisme menekankan observasi dan pengalaman indrawi sebagai sumber utama pengetahuan [@Babbie2021; @Kerlinger2000]. Pengetahuan diperoleh melalui pengamatan langsung terhadap fenomena, kemudian disusun menjadi kesimpulan berdasarkan pola yang ditemukan. Pendekatan ini menjadi fondasi penting dalam penelitian psikologi karena menekankan pentingnya data yang dapat diamati.
...
Kelemahan utama empirisme adalah ketergantungannya pada persepsi dan interpretasi manusia yang tidak selalu objektif. Observasi dapat dipengaruhi oleh bias peneliti, kesalahan pengukuran, atau kondisi situasional tertentu. Tanpa prosedur sistematis dan kontrol yang memadai, empirisme dapat menghasilkan generalisasi yang keliru.

![Cara-Cara Memperoleh Pengetahuan dan Keterbatasannya](images/pengetahuan.png){#fig-pengetahuan}

## Metode Ilmiah dan Penelitian Psikologi

Metode ilmiah merupakan pendekatan sistematis dalam memperoleh pengetahuan dengan mengintegrasikan rasionalisme dan empirisme dalam satu kerangka penyelidikan ilmiah [@Kerlinger2000; @Creswell2018]. Metode ini memungkinkan pengetahuan diperoleh secara objektif, terkontrol, dan dapat diuji.
...
Dalam psikologi, metode ilmiah digunakan untuk memastikan bahwa penjelasan mengenai perilaku dan proses mental manusia didasarkan pada bukti, bukan pada asumsi atau kepercayaan semata. @fig-siklusilmiah mengilustrasikan siklus metode penelitian ilmiah secara umum dalam proses pengembangan pengetahuan.

![Siklus Metode Ilmiah dalam Pengembangan Pengetahuan](images/siklusilmiah.png){#fig-siklusilmiah}
