...
### Pengendalian/Kontrol terhadap Variabel Luar

Selain memberikan perlakuan, peneliti eksperimen juga berupaya mengendalikan berbagai faktor lain yang dapat memengaruhi hasil penelitian. Faktor-faktor tersebut disebut **variabel luar** (*extraneous variables*), yaitu semua variabel selain variabel independen yang berpotensi memengaruhi variabel dependen [@Shadish2002; @Morling2024].

Tidak semua variabel luar akan memengaruhi hasil penelitian. Namun, apabila suatu variabel luar berhubungan dengan variabel independen sekaligus memengaruhi variabel dependen, maka variabel tersebut disebut **variabel perancu** (*confounding variable*). Kehadiran variabel perancu dapat menyebabkan peneliti keliru menyimpulkan bahwa perubahan pada variabel dependen disebabkan oleh perlakuan, padahal sebenarnya dipengaruhi oleh faktor lain. Oleh karena itu, salah satu tujuan utama penelitian eksperimen adalah mencegah munculnya variabel perancu agar validitas internal penelitian tetap terjaga.

Sebagai contoh, seorang peneliti ingin menguji efektivitas pelatihan *mindfulness* dalam menurunkan stres akademik mahasiswa. Selama penelitian berlangsung, masa ujian semester telah berakhir sehingga beban akademik mahasiswa menurun secara alami. Jika kondisi tersebut ikut menyebabkan tingkat stres menurun, maka berakhirnya masa ujian menjadi variabel perancu. Akibatnya, peneliti tidak dapat memastikan apakah penurunan stres disebabkan oleh pelatihan *mindfulness* atau oleh berkurangnya beban akademik.

Untuk meminimalkan pengaruh variabel perancu, penelitian eksperimen menerapkan berbagai strategi pengendalian (lihat @tbl-kontrol). Masing-masing strategi memiliki tujuan yang berbeda, tetapi semuanya diarahkan untuk memastikan bahwa perbedaan hasil penelitian benar-benar disebabkan oleh perlakuan yang diberikan.

::: {#tbl-kontrol}
| Strategi | Penjelasan |
|:-----------------------------------|:-----------------------------------|
| **Kelompok kontrol** | Menggunakan kelompok pembanding yang tidak menerima perlakuan atau menerima perlakuan yang berbeda sehingga perubahan yang terjadi dapat dibandingkan dengan kelompok eksperimen. |
| ***Random assignment*** | Menempatkan partisipan ke dalam kelompok penelitian secara acak agar karakteristik partisipan tersebar secara relatif seimbang pada setiap kelompok. |
| **Standardisasi prosedur** (*holding variables constant*) | Menjaga agar seluruh kelompok memperoleh kondisi penelitian yang sama, misalnya instruksi, instrumen, ruangan, waktu, dan durasi pelaksanaan. |
| ***Matching*****/*Blocking*** | Memilih atau memasangkan partisipan maupun kelompok yang memiliki karakteristik awal yang relatif serupa ketika *random assignment* tidak memungkinkan dilakukan. |
| **Pengendalian statistik** | Memasukkan variabel yang diduga memengaruhi variabel dependen sebagai variabel kontrol pada tahap analisis sehingga pengaruh perlakuan dapat diestimasi dengan lebih akurat. |

: Strategi Pengendalian Variabel Luar dalam Penelitian Eksperimen
:::
