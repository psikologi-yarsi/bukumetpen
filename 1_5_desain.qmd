...
# Desain Penelitian dan Strategi Pengumpulan Data {#sec-desain}
...
Secara umum, desain penelitian mencakup beberapa komponen utama yang saling berkaitan. Komponen-komponen ini membentuk suatu sistem yang memastikan bahwa penelitian dilakukan secara logis dan sistematis. Sebagaimana ditunjukkan pada @fig-komponen, setiap komponen disusun secara berurutan, tetapi hasil evaluasi terhadap validitas dan kualitas penelitian dapat menjadi dasar untuk meninjau kembali komponen-komponen sebelumnya sehingga proses penelitian berlangsung secara siklik dan berkelanjutan.
...
4.  **Strategi analisis data**\
    Selain pengumpulan data, desain penelitian juga mencakup rencana mengenai bagaimana data tersebut akan dianalisis. Dalam penelitian kuantitatif, analisis biasanya menggunakan teknik statistik. Sedangkan dalam penelitian kualitatif, analisis sering melibatkan proses interpretasi makna melalui *coding* dan kategorisasi data.
...
![Hubungan Antarkomponen dalam Desain Penelitian](images/komponen.png){#fig-komponen}
...
Pada bagian ini, desain penelitian dijelaskan berdasarkan tiga dimensi utama, yaitu **jumlah kontak dengan partisipan, periode penelitian, dan sumber investigasi**. Masing-masing dimensi memberikan gambaran mengenai bagaimana penelitian dilakukan serta jenis informasi yang dihasilkan.
...
Dalam praktiknya, suatu penelitian dapat memiliki karakteristik dari lebih dari satu dimensi klasifikasi secara bersamaan. @fig-desain memberikan ringkasan mengenai berbagai klasifikasi desain penelitian yang dapat menjadi acuan dalam memilih strategi penelitian yang sesuai.

![Klasifikasi Desain Penelitian](images/desain.png){#fig-desain}
